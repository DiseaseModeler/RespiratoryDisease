...
last_lab_st <- format(max(df_st$week_end, na.rm = TRUE), "%b %d, %Y")
  ...
  list(
    p_us = make_panel(df_us, paste0("United States through ", last_lab_us), yrng_us),
    p_state = make_panel(df_st, paste0(str_to_title(target_state), " through ", last_lab_st), yrng_st)
  )
}
