...
p_ED_c19 <- ggplot(df_ED, aes(x = date)) +
  geom_point(aes(y = frac_ED_c19, colour = "COVID-19")) +   
  ...
  labs(
    title   = "Proportion of ED Visits Associated with COVID-19",
    x       = "Week ending",
    y       = "Percent occupied",
    colour  = "Pathogen"
  ) +
...
p_lab <- ggplot(the_df_labs, aes(x = date)) +
  geom_point(aes(y = covid_prop, colour = "COVID-19")) +   
  geom_point(aes(y = flu_prop,   colour = "Influenza")) +  
  scale_x_date(date_breaks = "1 week", date_labels = "%m/%d/%Y") +
...
p_gen_beds <- ggplot(df_occ_gen, aes(x = date)) +
  geom_point(aes(y = frac_beds_occ_C19, colour = "COVID-19")) +   
  geom_point(aes(y = frac_beds_occ_flu,   colour = "Influenza")) +  
  scale_x_date(date_breaks = "1 week", date_labels = "%m/%d/%Y") +
...
p_icu_beds <- ggplot(df_occ_ICU, aes(x = date)) +
  geom_point(aes(y = frac_beds_occ_C19_icu, colour = "COVID-19")) +   
  geom_point(aes(y = frac_beds_occ_flu_icu,   colour = "Influenza")) +  
  scale_x_date(date_breaks = "1 week", date_labels = "%m/%d/%Y") +  
  scale_y_continuous(limits = c(0, 50)) +     
  scale_colour_manual(
    values = c(
